...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="accountController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="appId" name="appId" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="ignore"  value='${accountPage.appId}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="appName" name="appName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="ignore"  value='${accountPage.appName}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="accountId" name="accountId" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="ignore"  value='${accountPage.accountId}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountName" name="accountName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="ignore"  value='${accountPage.accountName}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="qq" name="qq" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${accountPage.qq}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="industry" name="industry" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="ignore"  value='${accountPage.industry}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="generalizeLink" name="generalizeLink" type="text" style="width: 150px" class="inputxt"  datatype="url"  ignore="ignore"  value='${accountPage.generalizeLink}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="applyTime" name="applyTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*"  ignore="ignore" value='<fmt:formatDate value='${accountPage.applyTime}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="applyManName" name="applyManName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="ignore"  value='${accountPage.applyManName}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="passTime" name="passTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*"  ignore="ignore" value='<fmt:formatDate value='${accountPage.passTime}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
