...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="consumerRechargeController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="paperRecharge" name="paperRecharge" type="text" style="width: 150px" class="inputxt"  datatype="d"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="rebatesRecharge" name="rebatesRecharge" type="text" style="width: 150px" class="inputxt"  datatype="d"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="providerName" name="providerName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="consumerName" name="consumerName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="platform" name="platform" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="ourRebates" name="ourRebates" type="text" style="width: 150px" class="inputxt"  datatype="d"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="theyRebates" name="theyRebates" type="text" style="width: 150px" class="inputxt"  datatype="d"  ignore="checked" />
							<span class="Validform_checktip"></span>
