...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="consumerRechargeList" checkbox="false" pagination="true" fitColumns="true" title="客户充值信息" actionUrl="consumerRechargeController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="申请日期"  field="applyTime"  formatter="yyyy-MM-dd"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="账户ID"  field="accountId"  query="true"  queryMode="single"  dictionary="account,id,id"  width="120"></t:dgCol>
   ...
   <t:dgCol title="供应商ID"  field="providerId"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="客户ID"  field="consumerId"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="供应商名称"  field="providerName"  query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="客户名称"  field="consumerName"  query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="投放平台"  field="platform"  query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="我方返点"  field="ourRebates"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="对方返点"  field="theyRebates"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="充值成本"  field="rechargeCost"  queryMode="single"  width="120"></t:dgCol>
