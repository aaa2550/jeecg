package com.jeecg.sellinvoice.entity;
 ...
 */
@Entity
@Table(name = "sell_invoice", schema = "")
@SuppressWarnings("serial")
public class SellInvoiceEntity implements java.io.Serializable {
	/**主键*/
	...
	/**收票公司*/
	@Excel(name="收票公司",width=15,dictTable ="consumer",dicCode ="id",dicText ="name")
